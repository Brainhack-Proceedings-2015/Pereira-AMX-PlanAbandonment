...
atlas from the literature. For example, Brodmann areas 17, 18 and 19
...
order to normalize the signals, a previous tunning phase is required
with simple paradigms, depending on which paradigm will be executed. The
...
converted to a problem of plan abandonment and it become possible to
